...
module("libraries.shadowsShadowShapes.HeightShadow", package.seeall)

Shadows = require("shadows")
Transform = require("libraries.shadows.Transform")
OutputShadow = require("libraries.shadowsOutputShadow")

Shadow = require("libraries.shadowsShadowShapes.Shadow")
...
local Normalize = libraries.shadowsNormalize
local insert = libraries.shadowsInsert
...
function HeightShadow:GenerateShadows(Shapes, Body, DeltaX, DeltaY, DeltaZ, Light)
	...
	if libraries.shadowsPointInPolygon(Lx, Ly, Vertices) then
		...
		if Lz > Bz then
			...
			Output:SetLayer(z)
			Output:SetShader(libraries.shadowsHeightShader)
