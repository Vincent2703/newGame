module("libraries.shadows.Shaders", package.seeall)

Shadows = require("shadows")

libraries.shadowsBlurShader = love.graphics.newShader[[
...
libraries.shadowsBloomShader = love.graphics.newShader [[
	// Size of the canvas
	extern vec2 Size;
...
libraries.shadowsDarkenShader = love.graphics.newShader [[
...
libraries.shadowsAberrationShader = love.graphics.newShader[[
...
libraries.shadows.LightShader = love.graphics.newShader [[
...
libraries.shadowsShapeShader = love.graphics.newShader [[
...
-- Normal Map shader
libraries.shadowsNormalShader = love.graphics.newShader [[
...
libraries.shadowsHeightShader = love.graphics.newShader [[
...
libraries.shadowsDropShadows = love.graphics.newShader [[
