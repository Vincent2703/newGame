module("libraries.shadows.Body", package.seeall)
...
CircleShadow		=	require("libraries.shadows.ShadowShapes.CircleShadow")
...
function Body:Update()
	...
	libraries.shadowsinsertionSort(self.Shapes.Array)
