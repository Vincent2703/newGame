module("libraries.shadows.Light", package.seeall)
...
function Light:Update()
	...
	if self.Changed or self.World.Changed then
		...
		if self.Blur then
			...
			libraries.shadowsRadialBlurShader:send("Position", {self.Radius, self.Radius})
			libraries.shadowsRadialBlurShader:send("Radius", self.Radius)
